...
/*   Updated: 2026/04/08 19:19:15 by kblanche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	push_front_rec(t_ilist *self, t_ilist *new_node, t_ilist *first)
{
	if (self->next && self->next != first)
		push_front_rec(self->next, new_node, first);
	else
...
{
	if (self)
		push_front_rec(self, new_node, self);
}
